...
public class HandlingExceptionsTryCatch {
    public static void main(String[] args) {
		...
		} catch(FileNotFoundException e) {//this will result in the exception being caught in the catch block below.
	...
	public static void throwManyExceptions(int i)throws Exception { // throws declaration in the method signature means you are "ducking" the exception
		switch(i) {
