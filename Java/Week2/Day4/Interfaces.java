 ...
 public class Interfaces implements Comparable<Interfaces>{
     ...
     */
    public int compareTo(Interfaces other) {//implement compareTo for this class.CompareTo should return a negative value if this object's 'val' is less than another object's 'val', and positive otherwise. If 'val' is equal for both objects, return 0.
        if(val>other.val){
            return 1;
        }
